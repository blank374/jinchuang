...
- `face_signing_review.html`: browser-based side-by-side review page for signing-photo candidates.
...
Regenerate the review page with:

```powershell
.\scripts\generate_review_report.ps1
```
